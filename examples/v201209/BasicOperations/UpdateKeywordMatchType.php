 ...
 */
function UpdateKeywordMatchTypeExample(AdWordsUser $user, $adGroupId, $criterionId) {
  ...
  printf("Keyword with id '%s' has updated match type '%s'.\n",
      $adGroupCriterion->criterion->id, $adGroupCriterion->criterion->matchType);
}
